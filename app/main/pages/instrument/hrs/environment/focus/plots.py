...
def bmir_focus_plot(start_date, end_date):
    ...
    p.scatter(source=source, x='UTStart', y='FOCUS', color='blue', fill_alpha=0.2, size=12)
    p.scatter(source=source2, x='UTStart', y='FOCUS', color='red', fill_alpha=0.2, size=10)
